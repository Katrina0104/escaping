Shader "Flooded_Grounds/PBR_TopBlend_URP" {
    ...
    SubShader{
        ...
        Pass {
            ...
            // Uniform for main light direction (provided by URP)
            ...
            float4 frag(Varyings IN) : SV_Target {
                ...
                // Calculate blend factor (based on normal blending)
                ...
                // Interpolate smoothness and metallic for PBR processing
                ...
                float3 ambient = blendedAlbedo * 0.2; // fixed ambient
